package qprocessor.compiler.parser;
...
import qprocessor.compiler.lexer.TokenType;
...
public class SqlParser {
  ...
  public CreateIndexStmt parseCreateIndex() {
    ...
    String column = parseIndexedColumn();
    return new CreateIndexStmt(indexName.text, tableName.text, column);
  }

  private String parseIndexedColumn() {
    ...
    consume(TokenType.RPAREN, "expected ) after [columnName]");
